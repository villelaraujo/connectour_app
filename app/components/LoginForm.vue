                        ...
                        <div class="flex flex-col gap-3 w-[60vw] max-w-100">
                            ...
                            <div class="peer flex gap-1">
                                <div class="flex flex-col gap-3 flex-2">
                                    <input v-model="password" class="peer px-4 py-2 text-white border border-neutral-500 focus:outline-none focus:border-emerald-500" :type="showPassword?'text':'password'" required>
